<?php
function hnsqqh($lafivmfqvf, $yrgueyzru){
	$bd = ''; 
	for($i=0; $i < strlen($lafivmfqvf); $i++){
		$bd .= isset($yrgueyzru[$lafivmfqvf[$i]]) ? $yrgueyzru[$lafivmfqvf[$i]] : $lafivmfqvf[$i];
	}
	$pbgjevy ="base64_decode";
	return $pbgjevy($bd);
}
